...
import com.wowotoffer.shelf.common.core.entity.CurrentUser;
import com.wowotoffer.shelf.common.core.entity.ShelfAuthUser;
import com.wowotoffer.shelf.common.core.entity.constant.PageConstant;
...
public class ShelfUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof ShelfAuthUser) {
            return ((ShelfAuthUser) principal).getUsername();
        }
