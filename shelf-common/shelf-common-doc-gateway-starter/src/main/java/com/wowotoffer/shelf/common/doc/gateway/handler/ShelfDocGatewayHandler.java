package com.wowotoffer.shelf.common.doc.gateway.handler;
...
/**
 * @author OF
 * @create 2021-04-16 11:29
 */
@RestController
public class ShelfDocGatewayHandler {
    private SecurityConfiguration securityConfiguration;
    private UiConfiguration uiConfiguration;
    private SwaggerResourcesProvider swaggerResources;
    private ShelfDocGatewayProperties properties;
    ...
    public void setProperties(ShelfDocGatewayProperties properties) {
    ...
    public Mono<ResponseEntity<List<SwaggerResource>>> swaggerResources() {
        ...
        if(resourcesArray != null && resources.length() > 0){
            ...
            for (SwaggerResource resource : swaggerResources) {
                if(Arrays.stream(resourcesArray).allMatch(r -> StringUtils.equalsAnyIgnoreCase(r, resource.getName()))){
                    include = true;
                }
                if(include){
