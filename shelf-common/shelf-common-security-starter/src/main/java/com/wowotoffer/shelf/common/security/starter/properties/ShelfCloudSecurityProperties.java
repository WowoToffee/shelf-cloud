package com.wowotoffer.shelf.common.security.starter.properties;
 ...
 */
@ConfigurationProperties(prefix = "shelf.cloud.security")
public class ShelfCloudSecurityProperties {
