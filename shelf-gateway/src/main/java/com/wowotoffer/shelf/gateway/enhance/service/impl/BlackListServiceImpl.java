...
import com.wowotoffer.shelf.gateway.enhance.mapper.BlackListMapper;
...
public class BlackListServiceImpl implements BlackListService {
    ...
    public Flux<BlackList> delete(String ids) {
        ...
        return blackListMapper.deleteByIdIn(Arrays.asList(idArray)).doOnNext(routeEnhanceCacheService::removeBlackList);
    }
